...
public class SachForm extends javax.swing.JPanel {
    ...
    public Sach readForm() {
        ...
        TacGia cbxtacgia = (TacGia) cboTacgia.getSelectedItem();
        TheLoai cbxtheloai = (TheLoai) cboTheLoai.getSelectedItem();
        
        String tentg = cbxtacgia.getTentg();
        String theloai = cbxtheloai.getTenTheLoai();
    ...
    private void tblListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListMouseClicked
        try {
            ...
            //
            cboTacgia.setSelectedItem(s.getTentacgia());
