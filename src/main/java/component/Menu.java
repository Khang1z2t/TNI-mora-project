...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("ncc", "Nhà Cung Cấp", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("th", "Quản lý Kho", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("tv", "Membership", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("8", "Doanh thu", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("9", "Thanh toán", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("10", "Thống kê", Model_Menu.MenuType.MENU));
